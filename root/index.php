      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-11 ftco-animate text-center">
            <h1 class="mb-4">These poor animals deserve a lots of love and care</h1>
            <h1 class="mb-4">Stay Home Stay Safe</h1>
            <p><a href="https://en.wikipedia.org/wiki/Pet_adoption" class="btn btn-primary mr-md-4 py-3 px-4"> Learn more <span class="ion-ios-arrow-forward"></span></a></p>
          </div>
        </div>
      </div>
    </div>
    	...
    	<div class="container">
          ...
          <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
            <div class="d-block services active text-center">
              ...
              <div class="media-body">
                <h3 class="heading">Save a Life</h3>
                <p>Each year, it's estimated that more than one million adoptable dogs and cats are euthanized across the world, simply because too many pets come into shelters and too few people consider adoption when looking for a pet.</p>
                </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
            <div class="d-block services text-center">
              ...
              <div class="media-body">
                <h3 class="heading">Bragging Rights</h3>
          ...
          <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
            <div class="d-block services text-center">
              ...
              <div class="media-body">
                <h3 class="heading">Your Home Will Thank you</h3>
                <p> Adopting a mature pet not only gives older animals a second chance, it often means introducing them to your family will be much easier.</p>
              </div>
            </div>      
          </div>
        </div>
