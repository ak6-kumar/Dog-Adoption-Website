...
<html lang="en">
  <head>
    <title>Dog adoption-Gallery</title>
    <meta charset="utf-8">
  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
            ...
            <h1 class="mb-4">Our success stories</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="work mb-4 img d-flex align-items-end" style="background-image: url(images/gallery-2.jpg);">
            	...
            	<div class="desc w-100 px-4">
	              <div class="text w-100 mb-3">
	              	<span>Dog</span>
	              	<h2><a href="">Pomeranian</a></h2>
	              </div>
              </div>
            </div>
          </div>
          <div class="col-md-4 ftco-animate">
            <div class="work mb-4 img d-flex align-items-end" style="background-image: url(images/image_1.jpg);">
            	<a href="images/image_1.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="fa fa-expand"></span>
	    				</a>
            	<div class="desc w-100 px-4">
	              <div class="text w-100 mb-3">
	              	<span>Dog</span>
	              	<h2><a href="">Labrador Retriever</a></h2>
	              </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="work mb-4 img d-flex align-items-end" style="background-image: url(images/img.jpg);">
            	<a href="images/img.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="fa fa-expand"></span>
	    				</a>
            	<div class="desc w-100 px-4">
	              <div class="text w-100 mb-3">
	              	<span>Dog</span>
	              	<h2><a href="">Samoyed</a></h2>
	              </div>
              </div>
            </div>
          </div>
    ...
    <footer class="footer">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-lg-3 mb-4 mb-md-0">
						<h2 class="footer-heading">Dog Adoption</h2>
						<p>These poor animals deserve a lots of love and care.</p>
						<ul class="ftco-footer-social p-0">
              <li class="ftco-animate"><a href="http://twitter.com" data-toggle="tooltip" data-placement="top" title="Twitter"><span class="fa fa-twitter"></span></a></li>
              <li class="ftco-animate"><a href="http://facebook.com" data-toggle="tooltip" data-placement="top" title="Facebook"><span class="fa fa-facebook"></span></a></li>
              <li class="ftco-animate"><a href="http://instagram.com" data-toggle="tooltip" data-placement="top" title="Instagram"><span class="fa fa-instagram"></span></a></li>
            </ul>
					</div>
					<div class="col-md-6 col-lg-3 mb-4 mb-md-0">
              ...
              <div class="text">
                <h3 class="heading"><a href="https://www.independent.co.uk/life-style/queen-corgi-dog-separation-anxiety-coronavirus-lockdown-a9477006.html">Dogs will suffer severe separation anxiety after lockdown ends</a></h3>
                <div class="meta">
                  <div><a href="#"><span class="icon-calendar"></span> April 16, 2020</a></div>
                  <div><a href="#"><span class="icon-person"></span> Independent.co.uk</a></div>
            ...
            <div class="block-21 mb-4 d-flex">
              ...
              <div class="text">
                <h3 class="heading"><a href="https://www.independent.co.uk/life-style/health-and-families/coronavirus-pet-dog-can-you-catch-it-transmission-a9376926.html">Can you catch Coronavirus from your pet?</a></a></h3>
                <div class="meta">
                  <div><a href="#"><span class="icon-calendar"></span> April 21, 2020</a></div>
                  <div><a href="#"><span class="icon-person"></span> newyorktime.co</a></div>
              ...
              <li><a href="adopt.php" class="py-2 d-block">Adopt</a></li>
              ...
              <ul>
                <li><span class="icon fa fa-map"></span><span class="text">NIE College, Ashokapuram, Mysuru, Karnataka</span></li>
                <li><a href=""><span class="icon fa fa-phone"></span><span class="text">+91 8008 280 214</span></a></li>
                <li><a href="https://mail.google.com/mail/u/0/"><span class="icon fa fa-paper-plane"></span><span class="text">akshaykr@gmail.com</span></a></li>
                <li><a href="https://mail.google.com/mail/u/0/"><span class="icon fa fa-paper-plane"></span><span class="text">amankr@gmail.com</span></a></li>
              </ul>
            </div>
					</div>
				</div>
